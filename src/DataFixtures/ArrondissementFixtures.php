...
class ArrondissementFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
  public function load(ObjectManager $manager): void
  {
    ...
    $arrondissementsParCommune = [
      ...
      // Seulement un échantillon pour les autres communes
        ...
        'natitingou' => ['Kotopounga', 'Kouaba', 'Natitingou I', 'Natitingou II'],
    ...
    foreach ($arrondissementsParCommune as $communeSlug => $arrondissements) {
      ...
      if (!$this->hasReference('ville_' . $communeSlug, Ville::class)) {
        continue;
      }

      $ville = $this->getReference('ville_' . $communeSlug, Ville::class);
