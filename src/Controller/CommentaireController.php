...
class CommentaireController extends AbstractController
{
    ...
    ): Response
    {
      ...
      $journal->setModerateur($this->getUser()); // Utiliser setModerateur au lieu de setUtilisateur
      $journal->setDateValidation(new \DateTime()); // Utiliser dateValidation au lieu de dateAction
      ...
      return $this->redirectToRoute('app_signalement_show', [
          'id' => $signalementId,
          '_fragment' => 'commentaires' // Ce fragment fait défiler la page jusqu'à l'onglet des commentaires
      ]);
